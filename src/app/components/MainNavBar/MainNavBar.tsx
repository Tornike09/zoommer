...
export const MainNavBar = () => {
    ...
    return (
        <div className={styles.navBar}>
            <ul>
                {
                    navBar.map((navBarItem) => <li className={`${navBarItem.id === 1 ? styles.first : ''} ${navBarItem.id === 8 ? styles.last : ''}`}
                     onClick={() => handleNavCategory(navBarItem.category)} key={navBarItem.id}>
